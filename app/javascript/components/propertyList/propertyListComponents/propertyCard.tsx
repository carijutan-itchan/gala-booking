...
import GallerySlider from "../../../shared/slider/gallerySlider";
...
const PropertyListCard: FC<StayCardProps> = ({
  size = "default",
  className = "",
  data = DEMO_DATA,
  ratioClass,
  ...
  return (
    <div
      className={`nc-StayCard group relative bg-white border border-neutral-100 rounded-2xl overflow-hidden hover:shadow-xl transition-shadow ${className}`}
      data-nc-id="StayCard"
    >
      {renderSliderGallery()}
      <Link to={href}>
