...
const Header: FC = () => {
  return (
    <nav className="bg-white px-2 sm:px-4 py-2.5 fixed w-full z-40 top-0 left-0 border-b border-gray-200 ">
      <div className="container flex flex-wrap items-center justify-between mx-auto py-4 lg:py-5">
